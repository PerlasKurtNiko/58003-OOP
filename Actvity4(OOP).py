...
#widgets start from here
        ...
        self.btnmul = Button(win,text="Multiply", fg="Light Blue",command=self.mul)
        self.btnmul.place(x=250,y=200)
        self.btndiv = Button(win, text="Divide", fg="Red",command=self.div)
        self.btndiv.place(x=350,y=200)
        self.btnclear = Button(win, text="Clear", fg="Green",command=self.clear)
